...
from config import MOD_NAME, MOD_VERSION, CUR_AGENT, SOURCE_DIRS, EXPORT_DIR, SEPARATE_INIS
import textures
...
agent_dict: dict[str, List[SkinData]]
...
def create_ini() -> None:
    ...
    def collect_overrides_for_skin_type(skin_type: str) -> str:
        collected = ""
    ...
    if SEPARATE_INIS:
        ...
        for skin_type, suffix in kind_map.items():
